insert into USER (id, first_name, last_name, email, date_of_birth, is_admin, last_login, password, profile_picture) values (1, 'Anett', 'Izhaky', 'agregont32@mit.edu9', '2001-02-28 22:34:55', false, '2020-07-14 07:36:43', 'jCvdLdRMPw', 'https://robohash.org/minusevenietdolor.png?size=50x50&set=set1');
